...
$(document).ready(function() {
    ...
    $( ".card ").click(function() {
        soundFXElement.attr("src", "assets/audio/zapsplat_warfare_sword_swing_fast_whoosh_blade_ring_003_43812.mp3");
        soundFXElement.play();
    ...
    $( ".card img ").mouseenter(function() {
        soundFXElement.attr("src", "assets/audio/zapsplat_multimedia_game_sound_single_short_generic_click_pop_001_38516.mp3");
        soundFXElement.play();
    });
